...
See [Options Detail](./options) for full documentation of each option, [PictModel](./pict) for the PICT-compatible model parser, or [Constraint Shortcuts](/shortcuts/constraint) for a concise constraint builder API.
