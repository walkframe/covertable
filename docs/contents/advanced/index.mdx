...
| `constraints` | `Condition[]` | `undefined` | Declarative constraints evaluated under three-valued logic. See [Constraint Logic](/advanced/constraint-logic). |
...
See [Options Detail](./options) for full documentation of each option, or [PictModel](./pict) for the PICT-compatible model parser.
