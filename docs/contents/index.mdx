...
See [Constraint Logic](/development/constraint-logic#statistics) for full details on each field.
...
- Learn about [**Options**](./reference/options) including constraints, sorters, criteria, sub-models, and weights
- Use the [**PictModel**](./reference/pict) to parse and run full PICT-format models (parameters + constraints + sub-models + invalid values + weights)
